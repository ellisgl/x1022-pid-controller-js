...
PIDController.prototype.compute    = function()
{
    ...
    if(tChanged >= this.opts.Ts)
    {
        ...
        /**
         * u(k) = u(k - 1) + Kp(y(k - 1) - y(k)) + Ki * Ts * e(k) + Kd / Ts * (2y(k - 1) - y(k) - y(k - 2)) <-- old way, was way freaky.
        ...
        U2      = (this.opts.KD / Tss)  * (this.yk[0] - (2 * this.yk[1]) + this.yk[2]);  // Kd / Ts * (y(k) - 2y(k - 1) + y(k - 2)
        U       = U0 + U1 - U2;
